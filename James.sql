...
CREATE TABLE IF NOT EXISTS `James`.`Pregunta` (
  ...
  INDEX `fk_Pregunta_Test1_idx` (`id_test` ASC),
  CONSTRAINT `fk_Pregunta_Test1`
    FOREIGN KEY (`id_test`)
    REFERENCES `James`.`Test` (`id_test`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `James`.`Usuario_has_Test`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `James`.`Usuario_has_Test` (
  `id_usuario` INT NOT NULL,
  `id_test` INT NOT NULL,
  `calificacion` DOUBLE NULL,
  `fecha` VARCHAR(45) NULL,
  PRIMARY KEY (`id_usuario`, `id_test`),
  INDEX `fk_Usuario_has_Test_Test1_idx` (`id_test` ASC),
  CONSTRAINT `fk_Usuario_has_Test_Usuario1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `James`.`Usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Usuario_has_Test_Test1`
    FOREIGN KEY (`id_test`)
    REFERENCES `James`.`Test` (`id_test`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
